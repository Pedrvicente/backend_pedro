...
if(isset($_POST['insert_product'])){
    ...
    // verificar se campos estão preenchidos
     ...
     if($product_title == '' or $description == '' or $product_keywords == '' or $product_category == '' or $product_price == '' or $product_image == ''){
        ...
        $insert_products = "insert into `products` (product_title, product_description, product_keywords, category_id, product_price, product_image, date, status)  values('$product_title', '$description', '$product_category', '$product_price', '$product_image', NOW(), '$product_status')";
