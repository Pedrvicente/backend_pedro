<?php
    ...
    if(isset($_GET['edit_account'])){
        ...
        if(isset($_POST['user_update'])){
            ...
            $update_query = "UPDATE `user_table` SET username='$username', user_password='$user_password',user_email='$user_email',user_adress='$user_adress',user_mobile='$user_mobile' WHERE user_id=$update_id";
...
<body>
    ...
    <div class="mb-4">
        <input type="text" name="user_password" id="" value="<?php echo $user_password ?>" class="form-control w-50 m-auto">
    </div>
    <div class="mb-4">
